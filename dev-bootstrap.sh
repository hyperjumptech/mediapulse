...
# This script creates symlinks to the .env file in packages/env to the .env.local file in each app directory. This way, we can use the same .env file in all apps.
