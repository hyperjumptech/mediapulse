...
import { searchQuerySetsCustomActionsForManifest } from "./custom-actions";
...
export const searchQuerySetsDashboardPage = {
  ...
  description:
    "Versioned search query sets per ticker, generated by the query-analysis agent. Create, activate, and inspect queries used by data collection.",
  ...
  customActions: searchQuerySetsCustomActionsForManifest,
