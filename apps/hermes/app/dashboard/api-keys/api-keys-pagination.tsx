...
/**
 * Prev/Next pagination links for the API keys list. Disables Prev on first page and Next on last page.
 */
export const ApiKeysPagination = ({
  basePath,
  page,
  pageSize,
  total,
  ...
  return (
    <nav
      ...
      aria-label="API keys list pagination"
    >
