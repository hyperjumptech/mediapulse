...
import type { ApiKeySortDir, ApiKeySortField } from "@/lib/api-keys";

type ApiKeysSearchProps = {
...
/**
 * Search form for API keys by name. Submits via GET to preserve URL state.
 */
export const ApiKeysSearch = ({
  initialQuery = "",
  pageSize,
  sortBy,
  sortDir,
  ...
  const clearHref = `/dashboard/api-keys?size=${pageSize}&sort=${sortBy}&dir=${sortDir}`;
    ...
    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
      ...
      >
        ...
        <div className="flex-1 space-y-2">
          <Label htmlFor="api-keys-search" className="sr-only">
            Search by name
          </Label>
