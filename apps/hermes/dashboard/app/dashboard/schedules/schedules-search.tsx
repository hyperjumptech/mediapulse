...
/**
 * Search form for schedules by name or description. Submits via GET to preserve URL state.
 */
export const SchedulesSearch = ({
  ...
  const clearHref = `/dashboard/schedules?size=${pageSize}&sort=${sortBy}&dir=${sortDir}`;
