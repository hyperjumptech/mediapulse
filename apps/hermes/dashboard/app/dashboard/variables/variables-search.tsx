...
/**
 * Search form for variables by key. Submits via GET to preserve URL state.
 */
export const VariablesSearch = ({
  ...
  const clearHref = `/dashboard/variables?size=${pageSize}&sort=${sortBy}&dir=${sortDir}`;

  return (
    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
      <form
        action="/dashboard/variables"
        method="get"
