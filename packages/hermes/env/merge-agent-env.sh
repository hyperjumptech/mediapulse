...
# overrides (e.g. PORT, AGENT_PUBLIC_URL, DOMAIN_INTEGRATION_API_KEY) while sharing
# the rest from packages/hermes/env/.env. Portable for bash 3 (e.g. macOS default).
