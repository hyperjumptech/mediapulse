...
export const DEFAULT_COMPLETION_TRANSACTION_TIMEOUT_MS = 30_000;
export const DEFAULT_COMPLETION_TRANSACTION_MAX_WAIT_MS = 15_000;
...
export const applyInvocationCompletion = async (
  ...
  const {
    db,
    logger,
    transactionTimeoutMs = DEFAULT_COMPLETION_TRANSACTION_TIMEOUT_MS,
    transactionMaxWaitMs = DEFAULT_COMPLETION_TRANSACTION_MAX_WAIT_MS,
  } = deps;
